...
- **Acceptance Criteria:**
  - **Template fixture files** exist at `tests/fixtures/excel/omts-supplier-list-template.xlsx` (empty) and `omts-supplier-list-example.xlsx` (populated with example data) — generated by `generate_template.py`
